...
| `prefetcher.enabled` | Whether to enable CVMFS-CSI prefetching jobs.                                                                                                  |
| `prefetcher.plugin.image.repository` | Default container image repository for CVMFS CSI prefetching jobs.                                                             |
| `prefetcher.plugin.image.tag` | Default container image tag for CVMFS CSI prefetching jobs.                                                                           |
| `prefetcher.plugin.image.pullPolicy` | Pull policy for CVMFS CSI prefetching jobs.                                                                                    |
| `prefetcher.podSecurityContext` | Pod-level security context for CVMFS-CSI prefetching jobs.                                                                          |
| `prefetching.jobs` | Defintion of CVMFS-CSI prefetching tasks.                                                                                                        |
